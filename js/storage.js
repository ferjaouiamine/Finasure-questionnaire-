(function () {
  ...
  const empty = () => ({
    ...
    reportEmailStatus: "",
    reportEmailMessage: "",
    personalizedReportRequested: false,
    personalizedReportRequestedAt: "",
    personalizedReportNotificationSent: false,
  ...
  function migrateAssessmentData(raw) {
    ...
    return {
      ...
      personalizedReportRequested: Boolean(old.personalizedReportRequested),
      personalizedReportRequestedAt: String(old.personalizedReportRequestedAt || ""),
      personalizedReportNotificationSent: Boolean(old.personalizedReportNotificationSent),
